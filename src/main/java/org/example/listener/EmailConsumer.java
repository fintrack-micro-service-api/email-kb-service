...
public class EmailConsumer {
    ...
    public UserDtoClient getCustomerId(UUID customerId) {
        return webClient.build().get()
                .uri("https://api.fintrack.dev/fintrack-client-event-service/api/v1/customers/{customerId}", customerId)
                .retrieve()
    ...
    public List<UserDtoClient> getAllCustomers() {
        ApiResponse<List<UserDtoClient>> response = webClient.build().get()
                .uri("https://api.fintrack.dev/fintrack-client-event-service/api/v1/customers")
                .retrieve()
